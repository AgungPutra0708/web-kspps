...
@section('content')
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            @if (Session::get('role_petugas') === 'AO')
                <div class="w-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6 mb-4">
                            <a href="{{ route('input_simpanan_ao') }}" class="nav-link">
                        ...
                        <!-- Penarikan Card -->
                        <div class="col-xl-4 col-md-6 col-sm-6 mb-4">
                            <a href="{{ route('input_penarikan_ao') }}" class="nav-link">
                    ...
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Bayar Angsuran Anggota -->
                        <div class="col-xl-4 col-md-6 col-sm-6 mb-4">
                            <a href="{{ route('input_angsuran') }}" class="nav-link">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
