                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-lg-12 col-12">
                                    ...
                                    <span
                                        style="font-size:10px; line-height:1; display:inline-block; transform:scaleY(0.9);">
                                        Modal Anggota Hanya Bisa Ditarik Saat RAT atau Keluar dari Keanggotaan
                                        Koperasi/BMT
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 pt-0">
                                            ...
                                            <h6 class="text-secondary">Rp
                                                {{ number_format($item['saldo_akhir'], 0, ',', '.') }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
